...
<html>
  <head>
    ...
    <link href="/files/requestforinfoformmain/styles.css" type="text/css" rel="stylesheet"/>
  ...
  <body>
      ...
      <div id="u45" class="ax_default">
        <img id="u45_menu" class="img " src="/images/studenthome/u1_menu.png" alt="u45_menu"/>
		...
		<form name="viewapplications" action="/user/studenthome" method="get" onclick="document.forms['viewapplications'].submit();">
          ...
          <div id="u48" class="ax_default menu_item">
            <img id="u48_img" class="img " src="/images/requestforinfoformmain/u48.png"/>
...
<form name="requestforinfoform" style="height: 66px;" action="requestforinfo" method="post" modelAttribute="RequestForInformation">
      ...
      <div id="u53" class="ax_default text_field">
        <input id="u53_input" name="firstName" placeholder="First name" tabindex="1" type="text" value=""/>
      </div>

      <!-- Unnamed (Text Field) -->
      <div id="u54" class="ax_default text_field">
        <input id="u54_input" name="lastName" placeholder="Last name" tabindex="2" type="text" value=""/>
      </div>
      ...
      <div id="u58" class="ax_default text_field">
        <input id="u58_input" name="email" placeholder="email" tabindex="3" type="text" value=""/>
      </div>
      ...
      <!-- Unnamed (Droplist) -->
      <div id="u62" class="ax_default droplist">
            <select name="anticipatedProgram" tabindex="4" id="u62_input" title="Anticipated Program/ Major" class="required">
